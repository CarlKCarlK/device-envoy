...
//! Mixed backend demo for `generic` (ESP32-S3): 16x16 panel via SPI and one NeoPixel-style (WS2812) LED via RMT.
//!
//! Wiring:
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!("led16x16_plus_1_spi: panel on GPIO2 via SPI2, strip1 LED on GPIO38 via RMT (generic)");
