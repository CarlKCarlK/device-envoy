...
use device_envoy_esp::{
    ...
    init_and_start,
    servo::Servo as _,
    servo::{AtEnd, ServoPlayer as _, ServoPlayerHandle, combine, linear, servo_player},
    wifi_auto::{
...
#[expect(
    ...
    reason = "clamped range and bounded conversion keep this safe"
)]
fn value_to_angle(value: u8) -> u16 {
    let clamped = value.min(59);
    let scaled = (u32::from(clamped) * 180) / 59;
    u16::try_from(scaled).unwrap_or(180)
}
