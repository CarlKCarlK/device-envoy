...
//! **For details see:**
//!
//! - [`led2d!`](macro@crate::led2d) — Macro to generate an LED-panel struct type. See [`Led2dGenerated`](`crate::led2d::led2d_generated::Led2dGenerated`) for a sample of a generated type.
