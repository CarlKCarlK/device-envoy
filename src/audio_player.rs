...
//!   [`audio_player!`].
//! - [`audio_clip!`] - Macro to compile in external audio clips from files (includes syntax details).
...
//! ```
//!
//! # Example: Compiling in an External Audio Clip. Playing with Runtime Volume Changes and Looping.
//!
//! This example shows how to compile in an external audio clip from a file,
//! adjust its gain at compile time, and then play it in a loop while changing the runtime volume.
//! It also demonstrates how to stop playback and reset the volume.
//!
//! ```rust,no_run
//! # #![no_std]
//! # #![no_main]
...
/// Macro to compile in external audio clips from files (includes syntax details). See
