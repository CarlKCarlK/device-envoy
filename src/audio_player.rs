...
//!   [`audio_player!`].
//! - [`pcm_clip!`] - Macro to "compile in" an audio clip from an external file (includes syntax details).
//!   See [`AudioClipGenerated`](audio_clip_generated::AudioClipGenerated)
//!   for a sample of a generated items.
//! - [`adpcm_clip!`] - Macro to "compile in" an ADPCM WAV clip from an external file.
//! - [`silence!`](macro@crate::silence) - Macro to generate an ADPCM silence clip expression for a player and duration.
//! - [`AudioClipGenerated`](audio_clip_generated::AudioClipGenerated) -
//!   Sample module showing clip constructors generated by
//!   [`pcm_clip!`].
//! - [`PcmClipBuf`] - Sized, const-friendly storage for static audio clip
//!   data. You can write your own compile-time (`const fn`) clip transforms
//!   using [`PcmClipBuf::new`] and [`PcmClipBuf::samples`].
//! - [`PcmClip`] - Unsized view of static PCM clip data. `&PcmClip` (of varying lengths) can be sequenced together.
//!
...
//!     let _nasa_sample_count = Nasa::SAMPLE_COUNT;
//!     let _digit_sample_count = Digit0::SAMPLE_COUNT;
//!
...
/// [`PcmClip`].
///
/// Use [`PcmClipBuf::new`] and [`PcmClipBuf::samples`] to build your own
...
///
/// let clip22050: PcmClipBuf<22_050, 4> = PcmClipBuf::new([0; 4]);
    ...
    PcmClip<SAMPLE_RATE_HZ, [i16; SAMPLE_COUNT]>
{
    ...
    /// samples with [`PcmClipBuf::samples`] and building a new clip with
    /// [`PcmClipBuf::new`].
    ///
...
/// - `adpcm256_clip()` - `const` function that returns the generated clip encoded as ADPCM (256-byte blocks)
/// - `adpcm256_clip_from(...)` - `const` function that ADPCM-encodes a provided PCM clip (256-byte blocks)
// TODO00 Review and refine generated docs for `adpcm256_clip_from(...)`.
///
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            #[doc = concat!(
                ...
                "[`pcm_clip`](Self::pcm_clip), [`adpcm256_clip`](Self::adpcm256_clip), ",
            ...
            $vis mod $name {
                ...
                #[must_use]
                pub const fn adpcm256_clip() -> $crate::audio_player::AdpcmClipBuf<
                    { SAMPLE_RATE_HZ },
                    { ADPCM_DATA_LEN },
                > {
                ...
                #[doc = "Const ADPCM (256-byte block) constructor generated by [`pcm_clip!`](macro@crate::audio_player::pcm_clip) for a provided PCM clip."]
                #[must_use]
                pub const fn adpcm256_clip_from(
                    pcm_clip: $crate::audio_player::PcmClipBuf<
                        { SAMPLE_RATE_HZ },
                        { SAMPLE_COUNT },
                    >,
                ) -> $crate::audio_player::AdpcmClipBuf<
                    { SAMPLE_RATE_HZ },
                    { ADPCM_DATA_LEN },
                > {
                    pcm_clip.with_adpcm::<ADPCM_DATA_LEN>()
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            $vis mod $name {
                ...
                #[must_use]
                pub const fn pcm_clip() -> $crate::audio_player::PcmClipBuf<SAMPLE_RATE_HZ, SAMPLE_COUNT> {
                    $crate::audio_player::resample_pcm_clip::<
                        SOURCE_SAMPLE_RATE_HZ,
                        SOURCE_SAMPLE_COUNT,
                        TARGET_SAMPLE_RATE_HZ,
                ...
                #[must_use]
                pub const fn adpcm_clip() -> $crate::audio_player::AdpcmClipBuf<SAMPLE_RATE_HZ, DATA_LEN> {
                    if TARGET_SAMPLE_RATE_HZ == SOURCE_SAMPLE_RATE_HZ {
                        ...
                        $crate::audio_player::AdpcmClipBuf::<SAMPLE_RATE_HZ, DATA_LEN>::new(
                            parsed_wav.block_align as u16,
                            parsed_wav.samples_per_block as u16,
                            adpcm_data,
                        )
                ...
                pub const fn adpcm_clip_from(
                    pcm_clip: $crate::audio_player::PcmClipBuf<SAMPLE_RATE_HZ, SAMPLE_COUNT>,
                ) -> $crate::audio_player::AdpcmClipBuf<SAMPLE_RATE_HZ, DATA_LEN> {
