...
fn main() {
    ...
    generate_audio_data_i16(&manifest_dir, &out_dir);
...
fn generate_audio_data_i16(manifest_dir: &PathBuf, out_dir: &PathBuf) {
    ...
    let mut audio_sample_chunks = audio_sample_bytes.chunks_exact(2);
    if !audio_sample_chunks.remainder().is_empty() {
        panic!(
    ...
    let audio_sample_count = audio_sample_bytes.len() / 2;
    let mut generated = String::new();
    generated.push_str("// Auto-generated by build.rs. Do not edit.\n");
    generated.push_str(&format!(
        "pub const AUDIO_SAMPLE_COUNT: usize = {audio_sample_count};\n"
    ));
    generated.push_str(
        "pub const fn audio_sample_i16() -> [i16; AUDIO_SAMPLE_COUNT] {\n    [\n",
    );

    for sample_chunk_bytes in &mut audio_sample_chunks {
        let sample_value = i16::from_le_bytes([sample_chunk_bytes[0], sample_chunk_bytes[1]]);
        generated.push_str(&format!("    {sample_value},\n"));
    }
