...
For this crate, generation is wired through `xtask` for: `audio_player_generated`, `audio_clip_generated`, `led2d_generated`, `led_strip_generated`, and `servo_player_generated`.
