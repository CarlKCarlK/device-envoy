...
//! A device abstraction for playing and looping statically defined audio clips
//! on I2S audio hardware, with runtime-selected clip sequencing.
//!
//! This page provides the primary documentation for generated audio player
//! types and clip utilities. Clip sample data is predeclared as static values,
//! while clip order is selected at runtime.
//!
//! **See also:**
//!
...
//! - [`AudioClip`] - A const-friendly static audio clip; clips of different
//!   lengths can be sequenced together.
//!
...
// todo0 hide?
/// Self-describing static PCM clip reference view used by playback APIs.
///
...
/// Sized, const-friendly static PCM clip storage.
