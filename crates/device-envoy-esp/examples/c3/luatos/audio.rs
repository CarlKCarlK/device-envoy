...
#![allow(missing_docs)]
//! MAX98357A sample playback example using ESP32-C3 I2S.
//!
//! Wiring:
//! - Data pin (`DIN`) -> GPIO5
...
#[cfg(all(not(rust_analyzer), not(feature = "esp32c3")))]
compile_error!("This board example only supports --features esp32c3.");
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!("I2S ready: GPIO5 DIN, GPIO3 BCLK, GPIO4 LRCLK");
    info!(
