...
//!   Sample module showing `PcmClip` and `pcm_clip()` generated by
//!   [`pcm_clip!`].
...
/// - `Adpcm256Clip` - concrete ADPCM clip type for this namespace
/// - `adpcm256_clip()` - `const` function that returns the generated clip encoded as ADPCM (256-byte blocks)
/// - `adpcm256_clip_from(...)` - `const` function that ADPCM-encodes a provided `PcmClip` (256-byte blocks)
// TODO00 Review and refine generated docs for `Adpcm256Clip` and `adpcm256_clip_from(...)`.
///
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            $vis mod $name {
                ...
                #[doc = "Concrete clip type generated by [`pcm_clip!`](macro@crate::audio_player::pcm_clip)."]
                ...
                pub type Adpcm256Clip = $crate::audio_player::AdpcmClipBuf<
                    { SAMPLE_RATE_HZ },
                    { ADPCM_DATA_LEN },
                >;
