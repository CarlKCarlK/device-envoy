...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    let button_watch6 =
        ForcePortalButtonWatch::new(p.GPIO6, PressedTo::Ground, spawner)
            .await?;
    ...
    let top_servo_player = TopServoPlayer::new(&ledc, p.GPIO11, spawner)?;
...
impl ServoClockDisplay {
    ...
    async fn set_angles(&self, left_degrees: i32, right_degrees: i32) {
        ...
        let right_angle = u16::try_from(top_degrees)
            .expect("servo angles must be between 0 and 180 degrees");
        info!(
