...
- `silence_32.s16`: expected output for `PcmClipBuf::silence()` with 32 samples
- `tone_440hz_32.s16`: expected output for `PcmClipBuf::tone(440)` with 32 samples
...
- `tone_440hz_32_resampled_16000hz_23.s16`: expected output for `tone(...).with_resampled::<16000, 23>()`
- `tone_440hz_32_resampled_22050hz_16.s16`: expected output for `tone(...).with_resampled::<22050, 16>()`
