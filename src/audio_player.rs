...
//!   data used by generated clip constructors and transform helpers.
...
/// - `SAMPLE_COUNT` - legacy alias of `PCM_SAMPLE_COUNT`
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            $vis mod $name {
                ...
                #[doc = "Legacy alias of [`PCM_SAMPLE_COUNT`]."]
...
/// - `<Name>::SAMPLE_COUNT` (legacy alias)
/// - `<Name>::ADPCM_DATA_LEN`
/// - `<Name>::DATA_LEN` (legacy alias)
/// - `<Name>::adpcm_clip()`
/// - `<Name>::pcm_clip()`
/// - `<Name>::pcm_clip_from(...)`
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            $vis mod $name {
                ...
                #[doc = "Legacy alias of [`ADPCM_DATA_LEN`]."]
                pub const DATA_LEN: usize = ADPCM_DATA_LEN;
