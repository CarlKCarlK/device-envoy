...
use device_envoy_esp::clock_sync::{ClockSyncEsp, ClockSyncStatic, ONE_SECOND};
...
fn test_two_clock_syncs(stack: &'static Stack<'static>, spawner: Spawner) {
    static CLOCK_SYNC0_STATIC: ClockSyncStatic = ClockSyncEsp::new_static();
    static CLOCK_SYNC1_STATIC: ClockSyncStatic = ClockSyncEsp::new_static();
