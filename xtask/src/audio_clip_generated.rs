...
pub mod AudioClipGenerated {
    ...
    /// Concrete clip type generated by [`audio_clip!`](macro@crate::audio_player::audio_clip).
    pub type AudioClip = AudioClipBuf<VOICE_22050_HZ, 92_160>;

    /// Const constructor generated by [`audio_clip!`](macro@crate::audio_player::audio_clip).
    #[must_use]
