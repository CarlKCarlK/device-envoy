...
//! Mixed backend demo for `esp32-c6-devkitc-1-n8` (ESP32-C6): 16x16 panel via SPI and one NeoPixel-style (WS2812) LED via RMT.
//!
//! Wiring:
//! - GPIO2: 16x16 NeoPixel-style (WS2812) panel data-in (SPI MOSI)
//! - GPIO8: built-in NeoPixel-style (WS2812) LED (RMT)
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!(
        "led16x16_plus_1_spi: panel on GPIO{} via SPI2, strip1 LED on GPIO{} via RMT (esp32-c6-devkitc-1-n8)",
