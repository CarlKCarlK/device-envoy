...
impl LedGenerated {
    ...
    pub fn new(
        pin: embassy_rp::Peri<'static, embassy_rp::peripherals::PIN_1>,
        on_level: OnLevel,
...
pub fn generate_led_generated(workspace_root: &Path) -> Result<(), Box<dyn Error>> {
    let output_path = workspace_root.join("src/led/led_generated.rs");
