...
For this crate, generation is wired through `xtask` for: `audio_player_generated`, `audio_clip_generated`, `ir_generated`, `lcd_text_generated`, `led_strip_generated`, and `servo_player_generated`.
