...
//! Mixed backend demo for `generic` (ESP32-S2): 16x16 panel via SPI and one NeoPixel-style (WS2812) LED via RMT.
//!
//! Wiring:
//! - GPIO2: 16x16 NeoPixel-style (WS2812) panel data-in (SPI MOSI)
//! - GPIO0: external NeoPixel-style (WS2812) LED data-in (RMT)
