import init, { DnsTesterWeb } from "./pkg/device_envoy_dns_tester_wasm.js?v=e656159fa13c";
...
try {
  await init({
    module_or_path: new URL("./pkg/device_envoy_dns_tester_wasm_bg.wasm?v=e656159fa13c", import.meta.url),
  });
