...
//! Shared RMT blocking demo for `esp32-s3-devkitc-1-v1.0-n16r8` (ESP32-S3): drive a 16x16 panel and one NeoPixel-style (WS2812) LED independently.
//!
//! Wiring:
//! - GPIO2: 16x16 NeoPixel-style (WS2812) panel data-in
//! - GPIO48: built-in NeoPixel-style (WS2812) LED
...
const LED_STRIP1_PIN_NUM: u8 = 48;
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!(
        "led16x16_plus_1: panel on GPIO{}, strip1 LED on GPIO{} (esp32-s3-devkitc-1-v1.0-n16r8)",
        PANEL_16X16_PIN_NUM, LED_STRIP1_PIN_NUM
    );

    let led16x16_dual = Led16x16Dual::new(p.GPIO2, rmt80.channel0, spawner)?;
    let led_strip1 = LedStrip1::new(p.GPIO48, rmt80.channel1, spawner)?;
