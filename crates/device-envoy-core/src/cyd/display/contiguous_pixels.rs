...
impl<const PIXEL_SOURCE_COUNT: usize> ContiguousPixels<PIXEL_SOURCE_COUNT> {
    ...
    #[cfg(test)]
    #[must_use]
    fn pixel_at(&self, point_x: i32, point_y: i32) -> Rgb565 {
    ...
    #[must_use]
    pub(crate) fn iter(&self) -> ContiguousPixelsIter<'_, PIXEL_SOURCE_COUNT> {
...
pub(crate) struct ContiguousPixelsIter<'a, const PIXEL_SOURCE_COUNT: usize> {
