...
const GENERATED_CONTENTS: &str = r#"// @generated by `cargo xtask servo-player-generated` or `cargo check-all`. Do not edit by hand.
...
/// provides. For first-time readers, start with the examples in the [`servo_player`](mod@crate::servo) module
...
pub fn generate_servo_player_generated(workspace_root: &Path) -> Result<(), Box<dyn Error>> {
    let output_path = workspace_root.join("src/servo_player/servo_player_generated.rs");
