...
#[cfg(target_os = "none")]
impl From<device_envoy_core::cyd::touch::calibration::EnsureCalibrationError<cyd::CydError, Error>> for Error {
    fn from(
        error: device_envoy_core::cyd::touch::calibration::EnsureCalibrationError<cyd::CydError, Error>,
    ) -> Self {
        match error {
