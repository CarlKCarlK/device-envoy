...
//! - Either:
//!   - 16-bit signed little-endian PCM audio (`s16le`)
//!   - 4-bit IMA ADPCM WAV data (`.wav`, mono)
...
//!   (includes syntax details). See
//!   [`PcmClipGenerated`](audio_clip_generated::PcmClipGenerated)
...
//!   See [`PcmClipGenerated`](audio_clip_generated::PcmClipGenerated) for
...
impl<const SAMPLE_RATE_HZ: u32> PcmClip<SAMPLE_RATE_HZ> {
    ...
    PcmClip<SAMPLE_RATE_HZ, [i16; SAMPLE_COUNT]>
{
    ...
    #[must_use]
    pub const fn with_adpcm_block_align<const DATA_LEN: usize>(
        &self,
        block_align: usize,
    ) -> AdpcmClipBuf<SAMPLE_RATE_HZ, DATA_LEN> {
        assert!(block_align >= 5, "block_align must be >= 5");
...
/// Audio clip source formats for [`pcm_clip!`]. Currently, only one format
/// is supported.
///
/// For ffmpeg conversion directions, see
/// [`pcm_clip!`](macro@crate::audio_player::pcm_clip) (the "Preparing
/// audio files for `pcm_clip!`" section).
...
/// [`PcmClipGenerated`](crate::audio_player::audio_clip_generated::PcmClipGenerated)
...
/// `static` definitions.
/// When you take `&Name::pcm_clip()` in a `static` context, the compiler
/// promotes that clip value into flash storage.
///
/// # Example
///
/// See [`PcmClipGenerated`](crate::audio_player::audio_clip_generated::PcmClipGenerated)
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            #[doc = concat!(
                ...
                "[`pcm_clip_from`](Self::pcm_clip_from), ",
            ...
            $vis mod $name {
                ...
                #[doc = "Const PCM constructor generated by [`pcm_clip!`](macro@crate::audio_player::pcm_clip) for a provided ADPCM clip."]
                #[must_use]
                pub const fn pcm_clip_from(
                    adpcm_clip: $crate::audio_player::AdpcmClipBuf<
                        { SAMPLE_RATE_HZ },
                        { ADPCM_DATA_LEN },
                    >,
    ...
    (
        ...
        $crate::audio_player::paste::paste! {
            ...
            $vis mod $name {
                ...
                #[must_use]
                pub const fn pcm_clip_from(
                    adpcm_clip: $crate::audio_player::AdpcmClipBuf<SAMPLE_RATE_HZ, ADPCM_DATA_LEN>,
                ) -> $crate::audio_player::PcmClipBuf<SAMPLE_RATE_HZ, PCM_SAMPLE_COUNT> {
                    adpcm_clip.with_pcm::<PCM_SAMPLE_COUNT>()
                }
                ...
                #[must_use]
                pub const fn adpcm_clip_from(
                    pcm_clip: $crate::audio_player::PcmClipBuf<SAMPLE_RATE_HZ, PCM_SAMPLE_COUNT>,
                ) -> $crate::audio_player::AdpcmClipBuf<SAMPLE_RATE_HZ, ADPCM_DATA_LEN> {
                    pcm_clip.with_adpcm_block_align::<ADPCM_DATA_LEN>(BLOCK_ALIGN)
                }
                ...
                #[must_use]
                pub const fn with_gain(
                    gain: $crate::audio_player::Gain,
                ) -> $crate::audio_player::AdpcmClipBuf<SAMPLE_RATE_HZ, ADPCM_DATA_LEN> {
