...
//! with per-rectangle frames (see [`super::CydDisplayTrait::frame_mut`]), this lets each status or time
...
/// Font apps typically pass to [`super::CydRp::new_display_only`] as the device default.
