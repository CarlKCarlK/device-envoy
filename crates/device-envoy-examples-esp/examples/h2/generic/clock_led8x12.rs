...
//! clock_led8x12: not supported on this board profile.
//!
//! Wiring:
...
let _ = spawner;
info!("clock_led8x12_esp32h2_generic: this example requires Wi-Fi, and ESP32-H2 does not offer that resource");
pending().await
}
