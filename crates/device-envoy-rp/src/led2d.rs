...
//! - [`Led2dApi`](`crate::led2d::Led2dApi`) — Core trait that defines the LED panel API surface.
...
/// Macro to generate an LED-panel struct type (includes syntax details). See [`Led2dApi`](`crate::led2d::Led2dApi`) for the shared API.
///
