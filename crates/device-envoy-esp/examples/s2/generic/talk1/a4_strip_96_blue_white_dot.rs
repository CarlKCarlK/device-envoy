...
#![allow(missing_docs)]
//! Talk 1 demo: 96-pixel strip/panel style sweep (single moving dot).
//!
//! Wiring:
//! - NeoPixel-style (WS2812) panel/strip data input -> GPIO18
//! - Panel/strip power -> 5V (or per panel spec), shared GND with board
