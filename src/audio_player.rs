//todo0 move the two macros into the submodule
//todo0 search and avoid almost every use of "PCM"
//todo0 improve 1st line
...
//! - [`AudioPlayer`] - Core runtime player type used by generated wrappers.
//! - [`AudioClip`] - Sized, const-friendly PCM clip storage.
//! - [`samples_ms!`](macro@crate::samples_ms) - Helper macro for compile-time
//!   clip sizing by duration.
