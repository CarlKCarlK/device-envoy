...
//! the [`audio_clip!`](macro@crate::audio_clip) macro.
//!
//! Auto-generated.
...
/// Sample module generated by the [`audio_clip!`](macro@crate::audio_clip)
/// macro, showing the generated namespace shape.
///
...
///
/// The generated namespace is a module (not a struct type) because stable Rust
...
pub mod AudioClipGenerated {
    ...
    /// Concrete clip type generated by [`audio_clip!`](macro@crate::audio_clip).
    pub type AudioClip = AudioClipBuf<VOICE_22050_HZ, 92_160>;

    /// Const constructor generated by [`audio_clip!`](macro@crate::audio_clip).
    #[must_use]
